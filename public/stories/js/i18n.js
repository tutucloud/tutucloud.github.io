...
const dict = {
  en: {
    ...
    modelsLoaded: ' models loaded — pick one below',
    ...
    corsDownload: 'Download extension (llm-bridge.zip)',
    corsStep1: 'Unzip the downloaded file to any folder',
  ...
  zh: {
    ...
    fetchModels: '获取模型列表',
    fetchingModels: '获取中…',
    modelsLoaded: ' 个模型已加载，请在下方选择',
    testOk: '连接成功，模型已响应。',
    testFail: '连接失败：',
    corsTitle: '检测到 CORS 问题',
    corsBody: '该供应商的 API 阻止浏览器直接请求。请安装 llm-bridge 扩展，安装后本程序会自动通过它转发请求。',
    corsDownload: '下载扩展（llm-bridge.zip）',
    corsStep1: '解压下载的 zip 到任意文件夹',
  ...
  ja: {
    ...
    fetchingModels: '取得中…',
    modelsLoaded: ' 件のモデルを読み込みました。以下から選択してください',
    ...
    corsDownload: '拡張機能をダウンロード（llm-bridge.zip）',
    corsStep1: 'ダウンロードした zip を任意のフォルダに展開',
